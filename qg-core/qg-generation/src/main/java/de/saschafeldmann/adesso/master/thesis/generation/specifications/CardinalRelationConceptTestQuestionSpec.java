 ...
 */
public class CardinalRelationConceptTestQuestionSpec implements TestQuestionSpecification {
     ...
     */
    public CardinalRelationConceptTestQuestionSpec(final Concept concept) {
